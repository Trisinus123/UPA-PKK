        ...
        <div class="col-xl-10 col-lg-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header text-black d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('jobs.index') }}" class="btn btn-sm text-white"
                    ...
                    <form action="{{ route('jobs.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="category_id" id="category_id" class="form-control select2-category" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" name="salary_min" id="salary_min" min="0"
                                    value="{{ old('salary_min') }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="salary_max" class="form-label">Gaji Maksimum (Rp)</label>
                                <input type="number" class="form-control" name="salary_max" id="salary_max" min="0"
                        ...
                        <div class="mb-4">
                            ...
                            <button type="button" id="add-document-requirement" class="btn btn-sm btn-secondary mt-2">
                                Tambah
                            </button>
                        </div>
